...
if __name__ == '__main__':
    macAddress = "00:00:00:00:00:00" # to update
    ...
    # Read samples, conversion in csv file by using numpy library
    a = numpy.asarray(device.read(nSamples))
    numpy.savetxt("ecg.txt", a, delimiter=" ")
    ...
    # Load raw ECG signal
    signal = numpy.loadtxt('ecg.txt', usecols=(5,))
